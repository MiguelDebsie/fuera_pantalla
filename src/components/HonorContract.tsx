...
export const HonorContract = ({ childName, onSign }: HonorContractProps) => {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-indigo-900 p-4 animate-in fade-in">
            <div className="bg-white rounded-3xl max-w-lg w-full p-8 shadow-2xl relative overflow-hidden border-8 border-yellow-400">
                {/* Decoration */}
                ...
                <div className="text-center mb-8">
                    <div className="w-20 h-20 bg-yellow-100 rounded-full flex items-center justify-center mx-auto mb-4 border-4 border-yellow-200">
                        <Scroll className="w-10 h-10 text-yellow-600" />
                    </div>
                    <h1 className="text-3xl font-black text-indigo-900 uppercase tracking-wide">Contrato de Honor</h1>
                    <p className="text-gray-500 mt-2">Compromiso de Foco y Disciplina</p>
                </div>

                <div className="bg-orange-50 p-6 rounded-xl border border-orange-100 mb-6 font-serif text-lg leading-relaxed text-gray-800 italic">
                    <p className="mb-4">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <label className="flex items-center gap-4 p-4 rounded-xl border-2 border-dashed border-gray-300 cursor-pointer hover:bg-gray-50 transition-colors">
                        <div className={`w-6 h-6 rounded border-2 flex items-center justify-center transition-colors ${isChecked ? 'bg-green-500 border-green-500' : 'border-gray-300'}`}>
                    ...
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full pl-12 pr-4 py-3 border-2 border-gray-200 rounded-xl font-handwriting text-2xl text-indigo-800 focus:border-indigo-500 outline-none transition-colors"
                            />
                        </div>
